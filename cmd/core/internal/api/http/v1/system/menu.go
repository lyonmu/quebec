...
// @Router    /v1/system/menu/{id} [delete]
func (b *SystemV1ApiGroup) SystemMenuDelete(c *gin.Context) {
	...
	if err := systemsvc.MenuDelete(c.Request.Context(), req.ID); err != nil {
		err.(*code.Response).Failed(c)
		return
	}
...
// @In        header
// @Name      x-quebec-token
// @Param     data  body      request.SystemMenuAddReq      true  "菜单信息"
// @Produce   json
// @Success   200  {object}  code.Response{code=number,message=string}  "50000,success"
// @Router    /v1/system/menu [post]
func (b *SystemV1ApiGroup) SystemMenuAdd(c *gin.Context) {

	var req request.SystemMenuAddReq
	if err := c.ShouldBindJSON(&req); err != nil {
		code.InvalidParams.Failed(c)
		return
	}

	if err := systemsvc.MenuAdd(c.Request.Context(), &req); err != nil {
		err.(*code.Response).Failed(c)
		return
	}
...
// @Name      x-quebec-token
// @Param     data  path      request.IdReq      true  "菜单ID"
// @Param     data  body      request.SystemMenuUpdateReq      true  "菜单信息"
// @Produce   json
// @Success   200  {object}  code.Response{code=number,message=string}  "50000,success"
// @Router    /v1/system/menu/{id} [put]
func (b *SystemV1ApiGroup) SystemMenuEdit(c *gin.Context) {
	...
	var req request.SystemMenuUpdateReq
	if err := c.ShouldBindJSON(&req); err != nil {
		code.InvalidParams.Failed(c)
		return
	}

	if err := systemsvc.MenuUpdate(c.Request.Context(), id.ID, &req); err != nil {
		err.(*code.Response).Failed(c)
		return
	}
